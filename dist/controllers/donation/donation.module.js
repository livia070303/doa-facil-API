...
exports.DonationModule = DonationModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: donation_schema_1.Donation.name, schema: donation_schema_1.DonationSchema }, { name: user_schema_1.User.name, schema: user_schema_1.UserSchema }], 'main'),
        ],

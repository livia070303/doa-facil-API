...
export class CadastroUsuarioService {
  constructor(@InjectModel(CadastroUsuario.name, 'main') private userModel: Model<CadastroUsuario>) {}
...
async updateCadastroUsuarioById(id: string, updateCadastroUsuarioDto: updateCadastroUsuarioDto): Promise<CadastroUsuario> {
  try {
